function e(e,t,i,r){Object.defineProperty(e,t,{get:i,set:r,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},a={},o=i.parcelRequired7c6;null==o&&((o=function(e){if(e in r)return r[e].exports;if(e in a){var t=a[e];delete a[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){a[e]=t},i.parcelRequired7c6=o),o.register("kyEFX",function(t,i){e(t.exports,"register",function(){return r},function(e){return r=e}),e(t.exports,"resolve",function(){return a},function(e){return a=e});var r,a,o={};r=function(e){for(var t=Object.keys(e),i=0;i<t.length;i++)o[t[i]]=e[t[i]]},a=function(e){var t=o[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),o("kyEFX").register(JSON.parse('{"5ZPII":"index.4d4158b8.js","iUwmD":"error-@1x-mobile.f594a12a.png","dgbdS":"error-@1x-tablet.4cd42245.png","5C3k6":"error-@1x-desctop.a7bff649.png","bVREt":"catalog.859d0afe.js","bLuY3":"catalog.efade936.js"}')),o("l4Na6"),o("3rDVG");const n=document.querySelector(".hero-section"),l=document.querySelector(".hero-container"),s=document.querySelector(".hero-modal-close"),c=document.querySelector(".hero-backdrop"),d=document.querySelector(".modal-wrap");var u=o("2shzp"),p=o("bkYP9"),m=o("8IXMh"),g=o("73Jqe"),u=o("2shzp"),f=o("7Y9D8"),p=o("bkYP9");async function v(e,t){try{let i=await (0,u.default).get(`
    ...
    <picture class="hero-picture">
      ...
      />
       ...
       `).join("");return t}(i)}(t,r);(0,g.addMarkup)(S,a),S.addEventListener("click",m.selectMovie)}catch(e){console.log(e.message)}}window.addEventListener("load",function(){E()});var u=o("2shzp"),p=o("bkYP9");const L=document.querySelector(".upcoming-container ");var M=(o("7gMLt"),o("7gMLt"));async function x(){try{let e,t;let i=await (0,u.default).get(`${p.BASE_URL}movie/upcoming`,{params:{api_key:p.API_KEY,language:"en-US"}}),r=i.data.results[Math.floor(Math.random()*i.data.results.length)],a=await $(),o=a.data.genres,n=r.genre_ids.map(e=>o.find(t=>t.id===e).name).slice(0,2).join(", ");r.genres=n,L.insertAdjacentHTML("beforeend",(e=r.overview,r.overview.length>300&&(e=r.overview),t=` 
  <div class ="upcoming-section-wrap">
    ...
    <div class="upcoming-info-wrap">
      ...
      <button class="btn js-add-remove-library" type="button" data-id="${r.id}">${(0,M.IsMovieInLibrary)(r.id)?"Remove from my library":"Add to my library"}</button>
      </div>
    </div>
  </div>`,r.results?'<h3 class="upcoming-alert">Ops! No upcoming films...</h3>':t));let l=document.querySelector(".js-add-remove-library");l.addEventListener("click",M.onAddRemoveMovie)}catch(e){console.log(e.message)}}window.addEventListener("load",function(){x()}),o("8IXMh"),o("gTaRf"),o("fsbGD"),o("aVGVk");
//# sourceMappingURL=index.4d4158b8.js.map
