...
const END_POINT = 'trending/movie/week?language=en-US&include_adult=false&include_video=false&page=1&per_page=10';
const STORAGE_KEY = 'ID';
const options = {
    method: 'GET',
    headers: {
        accept: 'application/json',
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJiZDBhNDQ5OWUzZjBiMDM2MDI1ZDEyNTk1Mzk3MjI3YSIsInN1YiI6IjY0N2YxZDM3Y2FlZjJkMDEzNjJjZDBjMyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.04GEOyHwNXnOZB4gUWNaiyPlLlOZ0z9Ttfl7T5UFMuk',
    },
};
...
function onSearchSubmit(event) {
    ...
    if (searchValue !== '') {
        ...
        fetchData(searchEndpoint, options)
            .then(response => {
                console.clear();
                console.log(response);
